...
// Classic demoscene rotozoomer — click/drag to shift rotation center
var rzCX, rzCY;
function renderRotozoomer() {
  ...
  var cx = W / 2, cy = H / 2;
  if (pointer.down && state.currentMode === 'rotozoomer') {
    rzCX = pointer.gx; rzCY = pointer.gy;
  }
  if (rzCX !== undefined) {
    cx = cx * 0.95 + rzCX * 0.05;
    cy = cy * 0.95 + rzCY * 0.05;
    rzCX = cx; rzCY = cy;
  }
...
registerMode('rotozoomer', { init: function(){ rzCX = undefined; rzCY = undefined; }, render: renderRotozoomer });
